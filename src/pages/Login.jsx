            ...
            <form onSubmit={handleSubmit} method='post' className="space-y-6 pr-4">
              ...
              <div className="relative">
                ...
                <button type="button" onClick={togglePassword} className="absolute inset-y-0 right-0 flex items-center px-2">
                  {showPassword ? (
                    <img className="h-4 w-4" src="../../dist/icons/password.png" alt="show-password" />
                  ) : (
                    <img className="h-3 w-3" src="../../dist/icons/closePass.png" alt="close-password" />
                  )}
                </button>
              </div>
              ...
              <div>
                ...
                >
                  <img src="../../dist/icons/google_logo.png" alt="" className="w-4 h-4 mr-2 rounded-full" />
                  Sign in with Google
                </button>
              </div>
            </form>

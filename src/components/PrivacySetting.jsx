        ...
        <div className='py-4 space-y-6'>
          ...
          <div className='space-y-6 px-4' >
            ...
            <div className='flex justify-between items-center'>
              ...
              <div  className='w-2 h-3'>
                <img src="../icons/active-black.png" alt='' />
              </div>
            </div>
            <div className='flex justify-between items-center'>
          ...
          <div>
            <div className='flex justify-between border-y border-y-color-lightGrey py-2 cursor-pointer'>
              <span className='flex space-x-2 items-center px-4'> <img src="../icons/document.png" alt="" className='w-4 h-4'/>
                <h6 className='text-color-grey text-[12px]  font-semibold'>Privacy policy</h6></span>

              <div className='px-4'>
                <img src='../icons/active-black.png' alt='' className='w-2 h-2'  />
              </div>
            </div>
            <div className='flex justify-between  py-2 cursor-pointer'>
              <span className='flex space-x-2 items-center px-4'> <img src="../icons/sms.png" alt="" className='w-4 h-4'/>

...
function ProfileSuggestion({ username, handle, isCertified, subscriptionStatus, online, className }) {
  return (
    ...
    <div className='profileStyle flex space-x-2 w-full justify-between items-center rounded p-3 h-16'>
    
        <img src="../profileImg.png" alt="profile image" className='w-12 h-12 p-[0.1rem] bg-gradient-to-t from-color-pink via-color-3 to-color-pink rounded-full' loading='lazy' />
      
{/* profile info */}
      <div className="text-color-white">
        <div className='flex items-center'>
          <h6 className='text-[0.8rem] font-semibold '>{username} </h6>
          {isCertified && <img src="../icons/certified.png" alt="certified" loading='lazy' className='w-4 h-4' />}
        </div>

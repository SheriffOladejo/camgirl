...
function Stories() {
  ...
  return (
    <section className="flex space-x-2 overflow-x-hidden mb-8 relative md:px-4 md:w-full w-[94vw]">
      ...
      <div className="overflow-x-scroll scroll-smooth flex space-x-2 carousel-body " >

        {stories.map((story, index) => (
          <a href="#" key={index} className="w-[56px] h-[56px] bg-gradient-to-t from-color-pink via-color-3 to-color-pink  aspect-square rounded-[50%] flex items-center justify-center  ">

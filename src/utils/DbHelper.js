...
class DbHelper  {
    ...
    //             response = JSON.parse(addDataIntoCache("createPost"), data);
    //         } 
    ...
    //         }
    //         //  else {
    //         //     const axiosResponse = await axios.get(`${Constants.BASE_API_URL}/getCommentsByPostID`, { params: data });
    //         //     response = { data: axiosResponse.data }; // Use the response from Axios
    //         // }
    //         response.data.sort((a, b) => b.creation_date - a.creation_date);
    //         for (let i = 0; i < response.data.length; i++) {
    ...
    //     const data = { "post_id": `${post_id}` };
    //     let response = null;
    //     if (getDataFromLocalStorage("getCommentCountByPostID") !== null) {
    //         response = (getDataFromLocalStorage("getCommentCountByPostID"), data);
    //     }
    //     //  else {
    ...
    //             response = JSON.parse(getDataFromLocalStorage("posts"), data);
    ...
    //         //     getDataFromLocalStorage('getPostsByUserID', data);
    //         //     response.data.sort((a, b) => b.creation_date - a.creation_date);
    //         //     for (let i = 0; i < response.data.length; i++) {
    //         //         const id = response.data[i]["id"];
    //         //         const user_id = response.data[i]["user_id"];
